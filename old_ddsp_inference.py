...
for duration_limit in duration_limits:
	...
	_ = knn_vc.bulk_match(src_dataset_path = arg.src_folder,  tgt_dataset_path = arg.tgt_folder, converted_audio_dir = converted_audio_dir, topk = arg.topk, device = arg.device, prioritize_f0 = arg.prioritize_f0, ckpt_type = arg.ckpt_type, tgt_loudness_db = arg.tgt_loudness_db, required_subset_file = arg.required_subset_file, post_opt = arg.post_opt, duration_limit = duration_limit)
